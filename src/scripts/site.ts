...
const historyLoop:Loop={name:'history',scene:document.querySelector('#baseline')!,size:document.querySelectorAll('[data-history-year]').length,index:0,paused:false,timer:null,animations:[],duration:3200,step(i,animate){
